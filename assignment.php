            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td> <input type="radio" name="donation" value="none" checked required> none
                        <input type="radio" name="donation" value="50" id="fifty" checked required> $50
                        <input type="radio" name="donation" value="75" id="seventyfive" checked required> $75
                        <input type="radio" name="donation" value="100" id="hundread" checked required> $100
                        <input type="radio" name="donation" value="250" id="twofifty" checked required> $250
